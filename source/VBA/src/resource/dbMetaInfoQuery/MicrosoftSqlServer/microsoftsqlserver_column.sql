SELECT
   ...
   ,CASE
        WHEN UPPER(C.DATA_TYPE) = 'CHAR'            AND C.CHARACTER_MAXIMUM_LENGTH IS NOT NULL THEN C.DATA_TYPE + '(' + CAST(C.CHARACTER_MAXIMUM_LENGTH AS VARCHAR(32)) + ')'
        WHEN UPPER(C.DATA_TYPE) = 'VARCHAR'         AND C.CHARACTER_MAXIMUM_LENGTH IS NOT NULL THEN C.DATA_TYPE + '(' + CAST(C.CHARACTER_MAXIMUM_LENGTH AS VARCHAR(32)) + ')'
        WHEN UPPER(C.DATA_TYPE) = 'NCHAR'           AND C.CHARACTER_MAXIMUM_LENGTH IS NOT NULL THEN C.DATA_TYPE + '(' + CAST(C.CHARACTER_MAXIMUM_LENGTH AS VARCHAR(32)) + ')'
        WHEN UPPER(C.DATA_TYPE) = 'NVARCHAR'        AND C.CHARACTER_MAXIMUM_LENGTH IS NOT NULL THEN C.DATA_TYPE + '(' + CAST(C.CHARACTER_MAXIMUM_LENGTH AS VARCHAR(32)) + ')'
        ...
        WHEN UPPER(C.DATA_TYPE) = 'BINARY'          AND C.CHARACTER_MAXIMUM_LENGTH IS NOT NULL THEN C.DATA_TYPE + '(' + CAST(C.CHARACTER_MAXIMUM_LENGTH AS VARCHAR(32)) + ')'
        WHEN UPPER(C.DATA_TYPE) = 'VARBINARY'       AND C.CHARACTER_MAXIMUM_LENGTH IS NOT NULL THEN C.DATA_TYPE + '(' + CAST(C.CHARACTER_MAXIMUM_LENGTH AS VARCHAR(32)) + ')'
        ELSE C.DATA_TYPE
